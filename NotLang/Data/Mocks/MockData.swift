...
extension TranslationChunk {
    ...
    static let commentCaVa = TranslationChunk(
        text: "comment ça va ?",
        translation: "how is it going?"
    )
    static let caVaBien = TranslationChunk(
        text: "Ça va bien",
        translation: "It's going well"
    )
    static let tellement = TranslationChunk(
        text: "tellement",
        translation: "so much"
    )
    ...
    // Dining & Requests
    static let jeVoudrais = TranslationChunk(
        text: "Je voudrais",
        translation: "I would like"
    )
    static let unCroissant = TranslationChunk(
        text: "un croissant",
        translation: "a croissant"
    )
    static let silVousPlait = TranslationChunk(
        text: "s'il vous plaît",
        translation: "please"
    )

    // Description & Places
    static let laTourEiffel = TranslationChunk(
        text: "La tour Eiffel",
        translation: "The Eiffel Tower"
    )
    static let estMagnifique = TranslationChunk(
        text: "est magnifique",
        translation: "is magnificent"
    )
    ...
    // Time & Weather
    static let ilFaitBeau = TranslationChunk(
        text: "Il fait beau",
        translation: "The weather is nice"
    )
    static let aujourdhui = TranslationChunk(
        text: "aujourd'hui",
        translation: "today"
    )
}
...
extension TranslationChunk {
    ...
    static let comoEstas = TranslationChunk(
        text: "¿cómo estás?",
        translation: "how are you?"
    )
    static let meGusta = TranslationChunk(
        text: "Me gusta",
        translation: "I like"
    )
    static let elCafe = TranslationChunk(
        text: "el café",
        translation: "the coffee"
    )

    // Japanese Samples
    static let konnichiwa = TranslationChunk(
        text: "こんにちは",
        translation: "Hello"
    )
    static let ogenki = TranslationChunk(
        text: "お元気ですか？",
        translation: "Are you well?"
    )

    // Italian Samples
    static let grazie = TranslationChunk(
        text: "Grazie",
        translation: "Thank you"
    )
    static let mille = TranslationChunk(
        text: "mille",
    ...
    static let laBibliotheque = TranslationChunk(
        text: "la bibliothèque",
        translation: "the library"
    )
    static let enchanté = TranslationChunk(
        text: "Enchanté",
        translation: "Nice to meet you"
    )
    static let toutLeMonde = TranslationChunk(
        text: "tout le monde",
